...
The 14 global functions use other global functions or DPDextractor methods: AntibSalesReader(), AntibSalesStats(), DataFromZipfiles(). CFmergeFiles2(), FileMerge() and HVmerge(), datasetVTransmerge(), datasetVmerge(), addActivity(), AddMergedIngredNames(), AddMergedIngredNames2(), addExtraVetcols(), addCategory(), and kdataset().
